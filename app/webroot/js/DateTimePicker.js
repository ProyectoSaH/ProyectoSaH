...
;(function ( $, window, document, undefined ) {
		...
		var defaults = {
			...
			shortDayNames: ["Domingo", "Lunes", "Martes", "Miercoles", "Jueves", "Viernes", "Sabado"],
			...
			titleContentDateTime: "Modificar Fecha & Tiempo",
		
			buttonsToDisplay: ["HeaderCloseButton", "SetButton", "ClearButton"],
			setButtonContent: "Cambiar",
		...
		DateTimePicker.prototype = {
			...
			_addEventHandlersForPicker: function()
			{
				...
				{
					dtPickerObj.dataObject.iCurrentMinutes+=30;
					dtPickerObj._setCurrentDate();
					dtPickerObj._setOutputOnIncrementOrDecrement();
				});
